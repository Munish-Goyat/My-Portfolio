...
import Resume from '../assets/Resume-Munish-Goyat.pdf'
    ...
    <div className='relative overflow-hidden min-h-[550px] sm:min-h-[600px] flex flex-col items-center'>
      ...
      data-aos-delay='500'>
        ...
        <p className='text-base sm:text-lg md:text-lg text-gray-200 mb-6'>
            with strong knowledge of React and modern web technologies, focused on building responsive, user-friendly, and dynamic
            applications.
        </p>
        <div className='flex items-center space-x-4 mb-6'>
            <a href="https://www.linkedin.com/in/munish-goyat">
                <img src={linkedin} alt="Linkedin" className='w-11 h-11' />
            </a>
            <a href="https://github.com/Munish-Goyat">
        ...
        <figure data-aos='fade-up' data-aso-delay='500' className='flex-1 flex justify-center md:justify-end mt-0'>
